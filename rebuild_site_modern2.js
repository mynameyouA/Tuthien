    ...
    <section class="section" style="background: var(--color-bg-alt); padding: 80px 20px;">
        <div class="container fade-in">
            ...
            <div class="grid-4" style="align-items: stretch;">
                <!-- Bronze -->
                <div class="card sponsor-card" style=" text-align: center; border-top: 8px solid #cd7f32; display: flex; flex-direction: column;">
                ...
                <!-- Silver -->
                <div class="card sponsor-card" style=" text-align: center; border-top: 8px solid #a8a8a8; display: flex; flex-direction: column; background: linear-gradient(to bottom, white, #fbfbfb);">
                    <div style="font-size: 3.5rem; margin-bottom: 20px;">🥈</div>
                ...
                <!-- Gold -->
                <div class="card sponsor-gold sponsor-card" style=" text-align: center; border-top: 8px solid #ffd700; display: flex; flex-direction: column;">
                ...
                <!-- Platinum -->
                <div class="card sponsor-card" style=" text-align: center; border-top: 8px solid #1e3a8a; display: flex; flex-direction: column; background: linear-gradient(135deg, #ffffff 0%, #f0f4f8 100%);">
