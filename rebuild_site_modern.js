            ...
            <div class="grid-4">
                ...
                <div>
                    ...
                    <ul style="list-style:none; line-height: 2.2; font-size: 0.95rem;">
                        <li><i class="fa-solid fa-location-dot" style="margin-right:8px; color:var(--color-secondary)"></i> Wyoming, USA</li>
...
const indexContent = `
        ...
        <div class="container fade-in">
            <div class="grid-2">
                ...
                <div style="position: relative;">
                    <img src="https://images.unsplash.com/photo-1611273426858-450d8e3c9cce?w=800&q=80" alt="Pollution Crisis" style="width: 100%; border-radius: var(--radius); box-shadow: var(--shadow-lg);" loading="lazy">
            ...
            <div class="card" style="padding: 0; overflow: hidden; border: none; box-shadow: var(--shadow-lg);">
                <div class="grid-2" style="gap: 0; align-items: stretch;">
                    ...
                    <div style="padding: 60px 50px; background: white; display: flex; flex-direction: column; justify-content: center;">
                        ...
                        <div>
                            <div style="font-family: 'Brush Script MT', 'Lucida Handwriting', cursive; font-size: 2.8rem; color: var(--color-primary); opacity: 0.8; margin-top: 10px; transform: rotate(-3deg); display: inline-block;">Duong Van Sinh</div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container fade-in">
            ...
            <div class="grid-3">
                <div class="card" style="padding: 50px 40px; border-top: 4px solid var(--color-primary); display: flex; flex-direction: column;">
                    ...
                    <div style="margin-top: auto; padding-top: 24px;"><a href="projects.html" class="btn btn-outline" style="width: 100%; border-color: var(--color-primary); color: var(--color-primary);">Discover Project</a></div>
                </div>
    ...
    <section class="section bg-light">
        <div class="container fade-in">
            <div class="grid-2" style="align-items: center;">
                <div>
                    <img src="https://images.unsplash.com/photo-1524661135-423995f22d0b?w=800&q=80" alt="Global Map" style="width: 100%; border-radius: var(--radius); box-shadow: var(--shadow-lg);" loading="lazy">
                </div>
                ...
                <div class="testimonial-carousel">
                    ...
                    <div class="testimonial-slide">
                        <div style="max-width: 800px; margin: 0 auto; text-align: center;">
                            ...
                            <div style="display: flex; align-items: center; justify-content: center; gap: 16px;">
                                <div style="width: 50px; height: 50px; border-radius: 50%; overflow: hidden;"><img src="https://images.unsplash.com/photo-1531123897727-8f129e1688ce?w=200&q=80" style="width:100%;height:100%;object-fit:cover;" loading="lazy"></div>
                    ...
                    <div class="testimonial-slide">
                        <div style="max-width: 800px; margin: 0 auto; text-align: center;">
                            ...
                            <div style="display: flex; align-items: center; justify-content: center; gap: 16px;">
                                <div style="width: 50px; height: 50px; border-radius: 50%; overflow: hidden;"><img src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=200&q=80" style="width:100%;height:100%;object-fit:cover;" loading="lazy"></div>
    ...
    <section class="section">
        <div class="container fade-in">
            <div class="grid-2" style="align-items: start;">
                ...
                <div>
                    <img src="https://images.unsplash.com/photo-1582213782179-e0d53f98f2ca?w=800&q=80" alt="Team in field" style="width: 100%; border-radius: var(--radius); box-shadow: var(--shadow-lg); margin-bottom: 40px;" loading="lazy">
...
const financialsContent = `
    <div class="page-hero fade-in">
        <img src="financials_hero.jpg" alt="Financials" class="page-hero-img" loading="lazy">
